  ...
  <tr>
    <td width="210"><div class="Menu" id="Menu">
      <table width="210" border="0" cellpadding="0" cellspacing="0" class="barramenu">
        ...
        <tr>
          <td class="links"><a href="index.php">REGISTRAR VENTAS </a></td>
        </tr>
        <tr>
          <td class="links"><a href="">REVISAR STOCK </a></td>
        </tr>
         <tr>
          <td class="links"><a href="">LISTADO DE PEDIDOS </a></td>
        </tr>
        <tr>
          <td><img src="Im&aacute;genes/adorno.jpg" width="210" height="50" alt="" /></td>
        </tr>
  ...
  <form id="formVenta" name="form1Venta" method="post" action="">
    <table>
      <tr>
        ...
        <h2 class="contenido">Su pedido fue realizado con exito, por favor acepte el envio de productos</h2>
        <table>
            <tr>
                <th>Insumo</th>
        ...
        <p><a href="">Aceptar nuevo Stock</a></p>   
        </td>
		  </tr>
